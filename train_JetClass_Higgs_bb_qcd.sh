...
# "kin", "kinpid", "full", "kin_Hadronic_QCD", "kin_Higgs_bb_leptonic", "kin_Higgs_bb_qcd"
FEATURE_TYPE=$2
[[ -z ${FEATURE_TYPE} ]] && FEATURE_TYPE="full"

if ! [[ "${FEATURE_TYPE}" =~ ^(full|kin|kinpid|kin_Hadronic_QCD|kin_Higgs_bb_leptonic|kin_Higgs_bb_qcd)$ ]]; then
...
$CMD \
    ...
    $dataopts $batchopts \
    --batch-size 64 --steps-per-epoch 18750 --steps-per-epoch-val 2500 --num-epochs $epochs --gpus 0 \

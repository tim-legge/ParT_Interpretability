...
qg_pf_features = np.load('./qg_data/qg_pf_features.npy')[:howmanyjets]
qg_pf_vectors = np.load('./qg_data/qg_pf_vectors.npy')[:howmanyjets]
qg_pf_mask = np.load('./qg_data/qg_pf_mask.npy')[:howmanyjets]
qg_pf_points = np.load('./qg_data/qg_pf_points.npy')[:howmanyjets]
qg_labels = np.load('./qg_data/qg_labels.npy')[:howmanyjets]
qg_model.eval()
with torch.no_grad():
...
tl_pf_features = np.load('./tl_data/tl_pf_features.npy')[:howmanyjets]
tl_pf_vectors = np.load('./tl_data/tl_pf_vectors.npy')[:howmanyjets]
tl_pf_mask = np.load('./tl_data/tl_pf_mask.npy')[:howmanyjets]
tl_pf_points = np.load('./tl_data/tl_pf_points.npy')[:howmanyjets]
tl_labels = np.load('./tl_data/tl_labels.npy')[:howmanyjets]
tl_model.eval()
with torch.no_grad():
...
#HLS4ML model loading and inference

hls4ml_state_dict = torch.load(hls4mltrained_modelpath, map_location=torch.device('cpu'))
hls4ml_model.load_state_dict(hls4ml_state_dict)
hls4ml_pf_features = np.load('./hls4ml_data/hls4ml_pf_features.npy')[:howmanyjets]
hls4ml_pf_vectors = np.load('./hls4ml_data/hls4ml_pf_vectors.npy')[:howmanyjets]
hls4ml_pf_mask = np.load('./hls4ml_data/hls4ml_pf_mask.npy')[:howmanyjets]
hls4ml_pf_points = np.load('./hls4ml_data/hls4ml_pf_points.npy')[:howmanyjets]
hls4ml_labels = np.load('./hls4ml_data/hls4ml_labels.npy')[:howmanyjets]
hls4ml_model.eval()
with torch.no_grad():
    hls4ml_y_pred= hls4ml_model(torch.from_numpy(hls4ml_pf_points),torch.from_numpy(hls4ml_pf_features),torch.from_numpy(hls4ml_pf_vectors),torch.from_numpy(hls4ml_pf_mask))
hls4ml_attention = hls4ml_model.get_attention_matrix()
hls4ml_interaction = hls4ml_model.get_interactionMatrix()
...
jck_pf_features = np.load('./jc_kin_data/jc_kin_pf_features.npy')[:howmanyjets]
jck_pf_vectors = np.load('./jc_kin_data/jc_kin_pf_vectors.npy')[:howmanyjets]
jck_pf_mask = np.load('./jc_kin_data/jc_kin_pf_mask.npy')[:howmanyjets]
jck_pf_points = np.load('./jc_kin_data/jc_kin_pf_points.npy')[:howmanyjets]
jck_labels = np.load('./jc_kin_data/jc_kin_labels.npy')[:howmanyjets]
jck_model.eval()
with torch.no_grad():
...
jc_kinpid_state_dict = torch.load(jc_kinpidtrained_modelpath, map_location=torch.device('cpu'))
jc_kinpid_model.load_state_dict(jc_kinpid_state_dict)
jc_kinpid_pf_features = np.load('./jc_kinpid_data/jc_kinpid_pf_features.npy')[:howmanyjets]
jc_kinpid_pf_vectors = np.load('./jc_kinpid_data/jc_kinpid_pf_vectors.npy')[:howmanyjets]
jc_kinpid_pf_mask = np.load('./jc_kinpid_data/jc_kinpid_pf_mask.npy')[:howmanyjets]
jc_kinpid_pf_points = np.load('./jc_kinpid_data/jc_kinpid_pf_points.npy')[:howmanyjets]
jc_kinpid_labels = np.load('./jc_kinpid_data/jc_kinpid_labels.npy')[:howmanyjets]
jc_kinpid_model.eval()
with torch.no_grad():
    jc_kinpid_y_pred= jc_kinpid_model(torch.from_numpy(jc_kinpid_pf_points),torch.from_numpy(jc_kinpid_pf_features),torch.from_numpy(jc_kinpid_pf_vectors),torch.from_numpy(jc_kinpid_pf_mask))
jc_kinpid_attention = jc_kinpid_model.get_attention_matrix()
jc_kinpid_interaction = jc_kinpid_model.get_interactionMatrix()

print('JC Kinpid done!')
